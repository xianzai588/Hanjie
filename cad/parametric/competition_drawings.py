...
def fixture_sheet(spec,result):
    ...
    notes(parts,["孔内接触件：开缝圆柱胀套，接触带z101～103、109～111",
                 ...
                 "锥半角10°；锥芯不接触工件孔",
                 "顶回肩＋拉杆；回退行程1.00",
                 f'名义扩张0.100 mm；理想轴向行程 {result["fixture"]["nominal_positive_return_stroke_required_mm"]:.3f}',
                 f'公差最不利端点所需回退行程 {result["fixture"]["positive_return_stroke_required_mm"]:.3f}',
