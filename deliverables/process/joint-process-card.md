...
| 松夹 | 停弧后≥120 s且最高温度<55℃；名义回退行程0.284 mm，最不利端点需0.312 mm；可用1.000 mm |
| 回收 | 底口开放、盘面朝上贴壁下撤，离开底口后封盖 |
| 焊后加工 | 候选A2：预加工孔Ø39.490～Ø39.500，最小径向余量0.250 mm；装入/接触/回退端点已筛查；焊后检查→终镗→最终CMM |
