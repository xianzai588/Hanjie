...
| 界面与过渡层 | ENiFe-CI为主填充；Ni/ENiCrFe-3高镍打底列为A/B对比路线，须以稀释率、宏观截面、硬度和裂纹检查决定 |
...
| 预热 / 层间 | 名义150℃；TWI铁素体球铁窗口RT～150℃、Kobelco 150～350℃、YAWATA易裂100～200℃；起弧前各点≥130℃且最高<200℃ |
...
| 焊后加工 | 预留径向加工余量，按A/B基准终镗或铰孔；最终孔轴由CMM验收 |
| 洁净判据 | 参照ISO 16232/VDA 19.1：≥0.5 mm颗粒0个、0.2～0.5 mm不超过5个，内窥覆盖率≥95% |
| 测量 | 20±1℃；测得位置度直径＋同口径不确定度≤0.05 mm |

收缩量级筛查显示焊后终加工必须作为主路线；薄裙热接触、胀套柔性、四道熔合与裂纹、完整热残余尚未验证；等面积守恒不等于实际成形。表面预处理、稀释控制与后热三项为工艺要求，须经小试金相与硬度线扫确认后方可升级为已评定工艺。焊材规格依据：https://certilas.com/en/product/nife-55-tig ，该页典型强度不作本接头许用值。
"""
