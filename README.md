...
**2026-09-23 COMPETITION-R1 RC11**：把QT450-10批次证明设为预热、PWHT和WPS/PQR的阻断门；补全NiFe无PWHT、NiFe+PWHT、Ni-CI+PWHT三条比较路线。将52.17 MPa和1.150统一限定为静力喉部筛查值/比值，疲劳焊趾与焊根独立评定并撤销未核实的FAT敏感性说法；将无实物影响限定为验证证据缺口，并重建含文献核验附件的提交包与RC11哈希。
