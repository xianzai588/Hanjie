...
**当前参赛版：COMPETITION-R1（RC10，2026-09-23）。** 采用6P四道TIG、Ø1.6棒材固定送丝、圆柱胀套独立夹紧和连续薄裙底口回收。终加工基准链为0.0138 mm径向分配、Ø0.0296 mm含目标测量不确定度的设计分配；不含焊接收缩，当前0.20 mm径向加工余量未闭合。实物精度、洁净和完整热—结构仍未认证。
