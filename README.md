...
**P2 数字证据链已运行**（2026-09-03）：已冻结约束与设计假设，统一 A/B/C 装配基准，完成参数化 CAD 工程表达图、15 组降阶筛选、5 组二维热—结构代理匹配对照及 41/51/61/81 网格检查、1000 次全析因蒙特卡洛、带运行时质量拒绝门的困难视觉样本和 100+100 异常检测基准。真实焊接、CMM、金相、硬度、NDT 和 WPS/PQR 不是参赛数字方案的提交前置条件，但仍是实际制造放行前的质量门。
