...
def main():
 ...
 summary={'version':'COMPETITION-R1-PREHEAT-SENSITIVITY-1','preheat_range_c':[150,350],'case_count':len(rows),'best_by_preheat':[],'interpretation':'模型未将预热温度耦合到残余收缩项；结果仅记录公式边界，不能评价预热对位置度的影响，也不进入竞赛证据链。'}
 for p in (150.,200.,250.,300.,350.):
